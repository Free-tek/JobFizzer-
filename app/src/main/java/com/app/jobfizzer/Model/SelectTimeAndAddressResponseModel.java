...
public class SelectTimeAndAddressResponseModel implements Serializable
{
    ...
    private final static long serialVersionUID = -265338552594325297L;
...
public class ListAddress implements Serializable
{
    ...
    @Expose
    private String city;
    private final static long serialVersionUID = 6369675990010692616L;
